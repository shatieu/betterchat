export default {
  ...
  'slash.h3': 'Heading 3',
  'slash.hr': 'Divider',
  'slash.snippets.explain': 'Explain step by step',
  'slash.snippets.fix': 'Fix grammar & spelling',
  'slash.snippets.summarize': 'Summarize',
  'slash.snippets.translate': 'Translate to English',
  'slash.table': 'Table',
